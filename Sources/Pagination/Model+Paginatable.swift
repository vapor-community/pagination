...
extension Model where Self: Paginatable & QuerySupporting & Content {
    ...
    public static func paginate(for req: Request, pageKey: String = Pagination.defaultPageKey, perPageKey: String = Pagination.defaultPerPageKey, _ sorts: [Self.QuerySort] = Self.defaultPageSorts) throws -> Future<Page<Self>> {
